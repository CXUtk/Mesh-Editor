...
//        if (!e->next->twin || !e->next->next->twin) return false;
//        auto twin = e->twin;
...
//
//        std::vector<const_PEdge> edges;
//        for (auto& e : _edges) edges.push_back(&e);
//        for (auto& e : edges) {
//            auto l = e->length();
//            if (l * 3 > 4 * L) {
...
//                    break;
//                }
//                auto n = collapseEdge(e->halfEdge, e->center());
//                cnt++;
//            }
//        }
//        removeFromList();
